...
// Query dasar - DIMODIFIKASI untuk menampilkan task yang dibuat ATAU ditugaskan ke user
$query = "
    SELECT t.*, 
                                ...
                                <tbody>
                                    <?php foreach ($tasks as $task): ?>
                                        <tr class="task-row" data-href="view_task.php?id=<?= $task['id'] ?>">
                                            ...
                                            <td>
                                                <?php if ($task['created_by'] == $userId && $task['assigned_to']): ?>
                                                    <div class="d-flex align-items-center">
                                                        <span class="badge bg-primary me-1" title="Ditugaskan ke tim produksi">
                                                            <i class="fas fa-arrow-right"></i>
                                                        </span>
                                                        <?= getUserProfilePhotoWithName($task['assigned_to'], $task['assigned_to_name'], "rounded-circle me-2", "24") ?>
                                                    </div>
                                                <?php elseif ($task['assigned_to'] == $userId && $task['created_by'] != $userId): ?>
                                                    <div class="d-flex align-items-center">
                                                        <span class="badge bg-success me-1" title="Ditugaskan oleh <?= htmlspecialchars($task['created_by_name']) ?>">
