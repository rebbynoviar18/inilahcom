...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $action === 'approve') {
    ...
    try {
        ...
        // Simpan link postingan untuk semua platform yang dipilih
                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-body d-flex flex-column justify-content-center">
                                    <?php if ($action === 'approve'): ?>
                                        ...
                                        <form method="POST">
                                            <!-- Opsi platform dan link -->
                                            <div class="mb-3">
                                                <label class="form-label">Pilih Platform dan Masukkan Link</label>
                                                <div class="card">
                                                    <div class="card-body">

                                                        <!-- Instagram -->
                                                        <div class="form-group mb-3">
                                                            <label for="platform_tiktok">Instagram</label>
                                                            <input type="hidden" name="platforms[]" value="instagram">
                                                            <input type="url" class="form-control" id="platform_instagram" name="links[]" 
                                                                   placeholder="https://www.instagram.com/......">
                                                        </div>

                                                        <!-- TikTok -->
                                                        <div class="form-group mb-3">
                                                            <label for="platform_tiktok">TikTok</label>
                                                            <input type="hidden" name="platforms[]" value="tiktok">
                                                            <input type="url" class="form-control" id="platform_tiktok" name="links[]" 
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="url" class="form-control" id="platform_facebook" name="links[]" 
                                                                   placeholder="https://www.facebook.com/...">
                                                        </div>
                                                        
                                                        <!-- Twitter (X) -->
                                                        <div class="form-group mb-3">
                                                            <label for="platform_twitter">Twitter (X)</label>
                                                            <input type="hidden" name="platforms[]" value="twitter">
                                                            <input type="url" class="form-control" id="platform_twitter" name="links[]" 
                                                                   placeholder="https://twitter.com/...">
                                                        </div>
                                                        
                                                        <!-- Threads -->
                                                        <div class="form-group mb-3">
                                                            <label for="platform_threads">Threads</label>
                                                            <input type="hidden" name="platforms[]" value="threads">
                                                            <input type="url" class="form-control" id="platform_threads" name="links[]" 
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="url" class="form-control" id="platform_youtube" name="links[]" 
